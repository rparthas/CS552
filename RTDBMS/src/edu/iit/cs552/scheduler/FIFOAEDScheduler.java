...
public class FIFOAEDScheduler extends TransactionScheduler implements
		Comparator<Transaction> {

	Random random = new Random();
	List<Transaction> missList = new ArrayList<Transaction>();
	Logger log = Logger.getLogger(FIFOAEDScheduler.class);
	...
	public FIFOAEDScheduler(List<String> columns, String table) {
		super(columns, table);
